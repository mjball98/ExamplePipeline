...
function grabReimbursements() {
	...
	//xhr.open('GET', 'http://localhost:8080/TRMS/api/Reimbursement/PendingForManager') //readyState 1
	//http://18.219.228.37:8088
	xhr.open('GET', 'http://18.219.228.37:8088/TRMS/api/Reimbursement/PendingForManager') //readyState 1
